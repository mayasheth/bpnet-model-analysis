...
|------|---------|--------------|------------|
| conventions.md | 16 sections | 2026-09-04 | Layout: analyses live at the repo root, not under `analysis/`, Reports, Figures, Environments, SLURM submit scripts (mandatory) |
...
Last summarized: 2026-09-04 (heuristic)
