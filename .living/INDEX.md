...
|------|---------|--------------|------------|
| conventions.md | 8 sections | 2026-08-25 | Layout: analyses live at the repo root, not under `analysis/`, Reports, Figures, Environments, SLURM submit scripts (mandatory) |
...
- **h3k27ac** (4 entries) — L-1, D-1, D-2, D-3
- **bpnetlite** (3 entries) — L-1, L-3, D-3
- **ceiling** (2 entries) — L-2, D-2
- **evaluation** (2 entries) — L-2, L-3
- **loss-weighting** (2 entries) — L-1, D-3
- **tooling** (2 entries) — L-4, L-6
...
- [2026-08-24] D-3: Keep the profile head, down-weighted, rather than removing it

## By tag

- `h3k27ac`: L-1, D-1, D-2, D-3
- `bpnetlite`: L-1, L-3, D-3
- `ceiling`: L-2, D-2
- `evaluation`: L-2, L-3
- `loss-weighting`: L-1, D-3
- `tooling`: L-4, L-6
- `training`: L-1, L-5
- `window-selection`: D-1, D-2
- `architecture`: D-3
- `bash`: L-4
- `buffering`: L-4
- `contamination`: D-2
