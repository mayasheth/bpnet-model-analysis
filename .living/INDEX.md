...
|------|---------|--------------|------------|
| conventions.md | 14 sections | 2026-09-03 | Layout: analyses live at the repo root, not under `analysis/`, Reports, Figures, Environments, SLURM submit scripts (mandatory) |
