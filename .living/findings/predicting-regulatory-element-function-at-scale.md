...
- Given the multimodal model beats explicit residual training (0.551 vs 0.459), is residual training useful at all here, or only as a diagnostic that the complement exists? Its value may be interpretability — its attributions are forced onto accessibility-independent signal.
