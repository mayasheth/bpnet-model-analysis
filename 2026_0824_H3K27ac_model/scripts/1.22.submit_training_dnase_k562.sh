...
#
# EXACTLY TWO changes vs 1.11: the accessibility bigwig, and the output directory.
#
...
#
# Baseline is models/multimodal5p_accs5p_hw500_clw10 from 1.11 with identical settings.
set -euo pipefail
...
ATAC_BW="/oak/stanford/groups/engreitz/Users/sheth/EP300_BPNet/2026_0824_H3K27ac_model/data/k562_dnase_5p.bw"
...
OUT_DIR="$PROJ/models/${MODE}5p_dnase_hw${HALF_WINDOW}_clw${COUNT_LOSS_WEIGHT}/fold${FOLD}"
