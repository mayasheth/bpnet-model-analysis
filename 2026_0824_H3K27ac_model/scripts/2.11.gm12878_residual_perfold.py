...
ATAC = "/oak/stanford/groups/engreitz/Users/sheth/EP300_BPNet/2026_0606_GM12878_transferability/data/atac.bw"
EL = "/oak/stanford/groups/engreitz/Users/sheth/EP300_BPNet/2026_0606_GM12878_transferability/reference/GM12878_candidate_elements.narrowPeak"
...
MODELS = [
    ("atac5p",             "atac",       f"{P}/models/gm12878_atac5p_hw500_clw10",                  False),
    ("sequence5p",         "sequence",   f"{P}/models/gm12878_sequence5p_hw500_clw10",              False),
    ("multimodal5p",       "multimodal", f"{P}/models/gm12878_multimodal5p_hw500_clw10",            False),
    ("residual_sequence",  "sequence",   f"{P}/models/gm12878_residual5p_sequence_hw500_clw10",     True),
    ("residual_multimodal","multimodal", f"{P}/models/gm12878_residual5p_multimodal_hw500_clw10",   True),
    ("residual_atac",      "atac",       f"{P}/models/gm12878_residual5p_atac_hw500_clw10",         True),
]
OUT_PREFIX = sys.argv[1] if len(sys.argv) > 1 else "gm12878_residual_grid_"
...
for fold in range(5):
    ...
    seqs, sigs, accs, _ = extract_windows(
        els, GEN, f"{P}/data/gm12878_h3k27ac_5p_plus.bw", f"{P}/data/gm12878_h3k27ac_5p_minus.bw",
