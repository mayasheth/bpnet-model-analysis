...
# Generated from 1.15.submit_training_fragchan.sh by scripts/make_fragwide_scripts.py.
...
# Generated from 1.11.submit_training_5prime_accs5p.sh by scripts/make_fragchan_scripts.py.
...
case "$MODE" in multimodal|atac) ;; *) echo "MODE must be multimodal or atac (sequence ignores the accessibility input)" >&2; exit 1 ;; esac
...
ATAC_BW="$PROJECT_DIR/2026_0529_multimodal_p300_model/data/atac_5p.bw,$PROJ/data/atac_sub5p.bw,$PROJ/data/atac_mono5p.bw,$PROJ/data/atac_di5p.bw,$PROJ/data/atac_poly5p.bw"
