#!/bin/bash
#
# ===== AUTO-DERIVED: sequence gates accessibility AND over-prediction weighted 3x =====
...
OUT_DIR="$PROJ/models/${MODE}5p_gate_asym_hw${HALF_WINDOW}_clw${COUNT_LOSS_WEIGHT}/fold${FOLD}"
