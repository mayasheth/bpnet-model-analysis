...
# Both panels plot *_topq metrics, so the all-element count this used to print was
# roughly fivefold too large. n_topq is the table's own column (2.30).
annotate_n_fig(fig, n_parts(("top quintile", fold_n_range(plain, n_col="n_topq"))))
