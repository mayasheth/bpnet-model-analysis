...
# Generated from 1.12.submit_training_gm12878_accs5p.sh by scripts/make_fragchan_scripts.py.
...
ATAC_BW="$TRANS/data/atac_5p.bw,$PROJ/data/gm12878_atac_sub5p.bw,$PROJ/data/gm12878_atac_mono5p.bw,$PROJ/data/gm12878_atac_di5p.bw,$PROJ/data/gm12878_atac_poly5p.bw"
