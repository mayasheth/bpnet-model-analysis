#### GOAL ####
# retrain p300 BPNet model with negatives = accessible but not p300-binding elements
...
# ep300_bam1=$OAK/Users/sheth/Data/ENCODE/K562/ENCFF466WKF.filtered.sorted.bam
# ep300_bam2=$OAK/Users/sheth/Data/ENCODE/K562/ENCFF163FSR.filtered.sorted.bam
# control_bam=$OAK/Users/sheth/Data/ENCODE/K562/ENCFF396DTD.sorted.bam
...
## 2) PREPARE INPUT PEAKS (previously completed) ## 

outliers_config=$OAK/Users/sheth/EP300_BPNet/2025_0325_K562_BPNet/config/input_outliers.json
ep300_peaks_inliers=$OAK/Users/sheth/EP300_BPNet/2025_0325_K562_BPNet/data/peak_inliers.bed
...
## 3) PREPARE NEGATIVES FROM ACCESSIBLE ELEMENTS ##

# narrow peak file, 2114 bp total
# just use all candidate elements that don't overlap p300 peaks = 124713
negatives=$OAK/Users/sheth/TF_analysis/2025_0609_K562_TF_annotations/analysis_v2/select_p300_negatives/K562_candidate_elements.no_EP300_peak_overlap.narrowPeak   
...
results_dir=$project_dir/2025_0703_retrain_p300_model
...
sbatch \
  ...
  --output=log/train_f${FOLD}.%j.txt \
  --error=log/train_f${FOLD}.%j.txt \
  --time=22:00:00 \
  $SCRIPTS_DIR/2.1.submit_training_one_fold.sh \
  $FOLD \
  $model_out_dir \
  $splits \
  $input_config \
...
cv_pred_dir=$project_dir/2025_0703_retrain_p300_model/predictions_cv
genome=$OAK/Users/sheth/hg38_resources/hg38.fa
chr_sizes=$OAK/Users/sheth/hg38_resources/GRCh38.main.chrom.sizes
...
project_dir=$OAK/Users/sheth/EP300_BPNet
pred_data_config=$project_dir/2025_0703_retrain_p300_model/config/input_data_predict.json
mean_pred_dir=$project_dir/2025_0703_retrain_p300_model/predictions_mean
genome=$OAK/Users/sheth/hg38_resources/hg38.fa
chr_sizes=$OAK/Users/sheth/hg38_resources/GRCh38.main.chrom.sizes
model_path_pattern="$project_dir/2025_0703_retrain_p300_model/models/fold{fold}/model_split000"
...
sbatch \
  ...
  --array=$ARRAY \
  $SCRIPTS_DIR/3.2.submit_mean_predict.sh \
    $model_path_pattern \
    $chr_sizes \
    $genome \
    $mean_pred_dir \
