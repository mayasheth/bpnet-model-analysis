...
#SBATCH -t 8:00:00  
#SBATCH --mem=64G
#SBATCH -o log/finemo_dnase.%j.txt
#SBATCH -e log/finemo_dnase.%j.txt
#SBATCH --job-name=finemo_dnase
#SBATCH -n 1
#SBATCH --ntasks 1
#SBATCH -G 2
...
out_dir=$this_dir/finemo_DNase; mkdir -p $out_dir

modisco_counts_h5=$data_dir/ENCFF404TKA/counts/tfmodisco.raw_output.counts.ENCSR000EOT.hd5 # 190k
counts_shap_h5=$data_dir/ENCFF739NDX/seq_contrib.counts.fold_mean.modisco_input.ENCSR000EOT.h5 # 190k
