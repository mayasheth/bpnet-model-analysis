...
#SBATCH --job-name=gm_mm_on_k562
#SBATCH -o /oak/stanford/groups/engreitz/Users/sheth/EP300_BPNet/2026_0606_GM12878_transferability/log/predict_gm_multimodal_on_k562.%j.txt
#SBATCH -e /oak/stanford/groups/engreitz/Users/sheth/EP300_BPNet/2026_0606_GM12878_transferability/log/predict_gm_multimodal_on_k562.%j.txt

# Mirror direction of the GM12878 transferability analysis: predict K562 candidate
# elements with the GM12878-trained sequence+ATAC multimodal BPNet (cross-cell-type).
# Usage: sbatch scripts/6.2.submit_predict_gm_multimodal_on_k562.sh
...
OUTPUT_DIR=$THIS_DIR/predictions/gm12878_multimodal_on_k562
