...
#SBATCH -t 24:00:00
#SBATCH --mem=120G
#SBATCH -o /oak/stanford/groups/engreitz/Users/sheth/EP300_BPNet/2026_0606_GM12878_transferability/log/train_gm12878_atac_only.%A_%a.txt
#SBATCH -e /oak/stanford/groups/engreitz/Users/sheth/EP300_BPNet/2026_0606_GM12878_transferability/log/train_gm12878_atac_only.%A_%a.txt
#SBATCH --job-name=gm12878_atac_only_f%a
#SBATCH -n 1
#SBATCH --ntasks 1
#SBATCH -G 1
...
# Train ATAC-only BPNet on GM12878 p300 ChIP-seq peaks.
# Input: 1-channel base-pair resolution ATAC profile (no DNA sequence).
# Usage: sbatch --array=0-4 scripts/1.2.submit_training_gm12878_atac_only.sh
...
OUTPUT_DIR=$THIS_DIR/GM12878_ATAC_only_BPNet/models/atac_only/fold${FOLD}

mkdir -p $OUTPUT_DIR

echo "$(date): Starting GM12878 ATAC-only training fold $FOLD"
